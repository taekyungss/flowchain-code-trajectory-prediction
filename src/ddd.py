...
if __name__ == "__main__":
    image_path1 = "output/config/TP/FlowChain/CIF_separate_cond_v_trajectron/tmp/visualize/density_map/update1_tmp_10_1_sum.png"  # 첫 번째 이미지 경로
    image_path2 = "output/config/TP/FlowChain/CIF_separate_cond_v_trajectron/tmp/visualize/density_map/update1_tmp_10_2_sum.png"  # 두 번째 이미지 경로
