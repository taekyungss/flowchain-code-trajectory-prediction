...
from src.data.TP.environment import Environment, Scene, Node, derivative_of
...
raw_path = 'C:/project/FlowChain-ICCV2023-main/src/data/TP/raw_data/'
data_folder_name = 'C:/project/FlowChain-ICCV2023-main/src/data/TP/processed_data'
...
for data_class in ['train', 'val', 'test']:
    ...
    for subdir, dirs, files in os.walk(os.path.join(raw_path, desired_source, data_class)):
        ...
        # subdir = "../src/data/TP/raw_data/tmp/test"
        # subdir = "C:/project/FlowChain-ICCV2023-main/src/data/TP/raw_data/tmp/test"
        # dirs = ['test']
        # files = ['tmp.txt']
        for file in files:
